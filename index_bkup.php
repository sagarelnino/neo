...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="assets/css/app.css?ver=<?php echo $GLOBALS['ver'] ?>">
            ...
            <div class="auth-form">
                <form action="" method="POST" id="login_form" onsubmit="return validate()">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="username" placeholder="ユーザー名を入力" name="username" value="<?php echo isset($_POST['username']) ? $_POST['username'] : ''; ?>">
